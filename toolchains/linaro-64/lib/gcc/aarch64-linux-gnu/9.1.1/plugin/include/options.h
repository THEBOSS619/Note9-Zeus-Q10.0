...
enum opt_code
{
  ...
  OPT_mbionic = 1273,                        /* -mbionic */
  OPT_mbranch_protection_ = 1274,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1275,                       /* -mcmodel= */
  OPT_mcpu_ = 1276,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1277,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1278,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1279,             /* -mgeneral-regs-only */
  OPT_mglibc = 1280,                         /* -mglibc */
  OPT_mlittle_endian = 1281,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1282,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1283,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1284,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1285,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1286,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1287,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1288,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1289,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1290, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1291,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1292,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1293,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1294,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1295,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1296,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1297,             /* -mtrack-speculation */
  ...
  OPT_pie = 1319,                            /* -pie */
  OPT_pipe = 1320,                           /* -pipe */
  OPT_posix = 1321,                          /* -posix */
  OPT_print_file_name_ = 1322,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1323,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1324,          /* -print-multi-directory */
  OPT_print_multi_lib = 1325,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1326,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1327,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1328,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1329,               /* -print-prog-name= */
  OPT_print_search_dirs = 1330,              /* -print-search-dirs */
  OPT_print_sysroot = 1331,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1332,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1333,                        /* -profile */
  OPT_pthread = 1334,                        /* -pthread */
  OPT_quiet = 1335,                          /* -quiet */
  OPT_r = 1336,                              /* -r */
  OPT_rdynamic = 1337,                       /* -rdynamic */
  OPT_remap = 1338,                          /* -remap */
  OPT_s = 1339,                              /* -s */
  OPT_save_temps = 1340,                     /* -save-temps */
  OPT_save_temps_ = 1341,                    /* -save-temps= */
  OPT_shared = 1342,                         /* -shared */
  OPT_shared_libgcc = 1343,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1344,               /* -shared-libphobos */
  /* OPT_specs = 1345, */                    /* -specs */
  OPT_specs_ = 1346,                         /* -specs= */
  OPT_static = 1347,                         /* -static */
  OPT_static_libasan = 1348,                 /* -static-libasan */
  OPT_static_libgcc = 1349,                  /* -static-libgcc */
  OPT_static_libgfortran = 1350,             /* -static-libgfortran */
  OPT_static_libgo = 1351,                   /* -static-libgo */
  OPT_static_liblsan = 1352,                 /* -static-liblsan */
  OPT_static_libmpx = 1353,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1354,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1355,               /* -static-libphobos */
  OPT_static_libstdc__ = 1356,               /* -static-libstdc++ */
  OPT_static_libtsan = 1357,                 /* -static-libtsan */
  OPT_static_libubsan = 1358,                /* -static-libubsan */
  OPT_static_pie = 1359,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1367,                      /* -std=c++2a */
  OPT_std_c__98 = 1368,                      /* -std=c++98 */
  OPT_std_c11 = 1369,                        /* -std=c11 */
  OPT_std_c17 = 1370,                        /* -std=c17 */
  /* OPT_std_c18 = 1371, */                  /* -std=c18 */
  /* OPT_std_c1x = 1372, */                  /* -std=c1x */
  OPT_std_c2x = 1373,                        /* -std=c2x */
  /* OPT_std_c89 = 1374, */                  /* -std=c89 */
  OPT_std_c90 = 1375,                        /* -std=c90 */
  OPT_std_c99 = 1376,                        /* -std=c99 */
  /* OPT_std_c9x = 1377, */                  /* -std=c9x */
  OPT_std_f2003 = 1378,                      /* -std=f2003 */
  OPT_std_f2008 = 1379,                      /* -std=f2008 */
  OPT_std_f2008ts = 1380,                    /* -std=f2008ts */
  OPT_std_f2018 = 1381,                      /* -std=f2018 */
  ...
  OPT_std_gnu__2a = 1391,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1392,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1393,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1394,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1395, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1396, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1397,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1398, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1399,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1400,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1401, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1402, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1403,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1404, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1405, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1406, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1407, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1408, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1409,                     /* -std=legacy */
  OPT_symbolic = 1410,                       /* -symbolic */
  OPT_t = 1411,                              /* -t */
  OPT_time = 1412,                           /* -time */
  OPT_time_ = 1413,                          /* -time= */
  OPT_traditional = 1414,                    /* -traditional */
  OPT_traditional_cpp = 1415,                /* -traditional-cpp */
  OPT_trigraphs = 1416,                      /* -trigraphs */
  OPT_u = 1417,                              /* -u */
  OPT_undef = 1418,                          /* -undef */
  OPT_v = 1419,                              /* -v */
  OPT_version = 1420,                        /* -version */
  OPT_w = 1421,                              /* -w */
  OPT_wrapper = 1422,                        /* -wrapper */
  OPT_x = 1423,                              /* -x */
  OPT_z = 1424,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
