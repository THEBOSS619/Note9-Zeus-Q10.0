...
inline int binder_stats_show(struct seq_file *m, void *unused)
{
	return 0;
}

inline int binder_transactions_show(struct seq_file *m, void *unused)
{
	return 0;
}

inline static int proc_show(struct seq_file *m, void *unused)
{
	return 0;
}
...
inline int binder_transaction_log_show(struct seq_file *m, void *unused)
{
	return 0;
}
