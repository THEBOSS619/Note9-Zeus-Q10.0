...
#else
static inline __printf(4, 5) void
sdev_prefix_printk(const char *level, const struct scsi_device *sdev,
		const char *name, const char *fmt, ...)
{
}

static inline __printf(3, 4) void
scmd_printk(const char *level, const struct scsi_cmnd *scmd,
		const char *fmt, ...)
{
}
#endif
