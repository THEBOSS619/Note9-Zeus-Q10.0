...
static inline void scsi_show_extd_sense(const struct scsi_device *sdev,
				 const char *name,
...
static inline void scsi_print_result(const struct scsi_cmnd *cmd,
				const char *msg, int disposition)
{
}
#endif
